...
| # | Title | Status | Date |
|---|-------|--------|------|
| [ADR-001](records/ADR-001-idioma-documentacion.md) | Documentation Language | Accepted | 2026-08-22 |
| [ADR-002](records/ADR-002-hexagonal-modular-monolith.md) | Architectural Style: Hexagonal Modular Monolith (Microservices-Ready) | Accepted | 2026-08-26 |
| [ADR-003](records/ADR-003-nginx-reverse-proxy.md) | NGINX as Reverse Proxy / Edge Layer | Accepted | 2026-08-26 |
